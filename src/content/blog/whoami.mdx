...
At the moment my main task, at work, is implementing a logging solution for the Node.js backend processes. And also fixing bugs whenever they appear in frontend, backend or the data pipeline.

I also really wanna work with Kubernetes and Terraform in the future. But I lack the Hardware to run a Kubernetes Cluster at home. So I am waiting for the day I can afford a decent server.
...
Right now the biggest challenges are ios compatibility and just not enough features. The project is still in the early stages of development.
