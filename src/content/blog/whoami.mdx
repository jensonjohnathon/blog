...
At the moment my main task, at work, is implementing a logging solution for the Node.js backend processes. And fixing bugs whenever they appear in frontend,backend or the data pipeline.
