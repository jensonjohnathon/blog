...
pubDate: 'Feb 15 2025'
heroImage: '../../assets/images/collatz_figure_title2.png'
category: 'Math'
tags: ['Python', 'Collatz']
---
...
To get the disired effect we change the angle of the line depending on the number being odd or even.

## The Code

While watching some Visualisations I came across [Ed Baker](https://ebaker.me.uk/notes/collatz-conjecture.html)'s visualisations of the Collatz Conjecture.
...
Feel free to play around with the code and create your own visualisations. The Title Image of this post is a result of the code below.
